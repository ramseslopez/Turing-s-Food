...
const $passwordConfirmationInput = document.querySelector('#inputPasswordConfirmation')
...
$passwordConfirmationInput.addEventListener('change', passwordInvalidClassHandler)
$passwordConfirmationInput.addEventListener('keydown', passwordInvalidClassHandler)
$passwordConfirmationInput.addEventListener('paste', passwordInvalidClassHandler)
$passwordConfirmationInput.addEventListener('input', passwordInvalidClassHandler)